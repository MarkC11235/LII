...
#define fr =
#define rn ;
#define showme std::cout 
#define that <<
#define quitshowingthat std::endl
#define imdone return
#define startthis int main(){
#define endthis }
#define numba int
...
startthis
    ...
    showme that a that " " that b that " " that c that quitshowingthat rn
