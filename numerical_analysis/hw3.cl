...
print "1/H_norm * resdiual_norm <= e_norm <= H_inv_norm * resdiual_norm";
print check_error_inequality;
print "";

let check_relative_error_inequality = (1/cond * resdiual_norm/b_norm <= e_norm/xexact_norm) 
                                      &&
                                      (e_norm/xexact_norm <= cond * resdiual_norm/b_norm);
print "1/K * resdiual_norm/b_norm <= e_norm/xexact_norm <= K * resdiual_norm/b_norm";
