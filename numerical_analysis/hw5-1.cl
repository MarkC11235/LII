let Taylor_Method_Order_2 = func(f, fp, y0, t0, t1, N){
    let h = (t1 - t0) / N;
    let t = t0;
    let y = y0;
...
// b)
let res10 = Taylor_Method_Order_2(f, fp, y0, t0, t1, 10);
let res100 = Taylor_Method_Order_2(f, fp, y0, t0, t1, 100);
let res1000 = Taylor_Method_Order_2(f, fp, y0, t0, t1, 1000);
let res10000 = Taylor_Method_Order_2(f, fp, y0, t0, t1, 10000);

print "Results for Taylor Method of Order 2 with different N values:";
